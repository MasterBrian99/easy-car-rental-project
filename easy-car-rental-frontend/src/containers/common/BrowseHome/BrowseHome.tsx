...
const BrowseHome = () => {
  ...
  return (
    <div className={`mainBackgrounds`}>
      <ContainerHeader />
{/* file:///C:/Users/brian/Desktop/work/easy-car-rental-private-limited/Easy-Car-Rental-Backend/target/Easy-Car-Rental-Backend-1.0.000/uploads/rp-bentley-continental-gt-v8-20-2-1570633139.jpg */}
